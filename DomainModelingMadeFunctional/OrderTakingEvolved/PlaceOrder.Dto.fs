...
// THE SAME AS PREVIOUS VERSION only few new fields are added (eg. Country, State)

// This file contains the type and logic for working with data transfer objects (DTOs)
//
...
//===============================================
// DTO type for ShippableOrderPlaced event
//===============================================
