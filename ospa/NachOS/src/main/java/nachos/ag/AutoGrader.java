...
public class AutoGrader {
  ...
  private final Hashtable<String, String> testArgs = new Hashtable<String, String>();
  ...
  /**
   * Notify the autograder that the current process has finished. <tt>UserProcess.exit()</tt>
   * <i>must</i> call this method.
   */
  public void finishingCurrentProcess(int status) {}

  /**
   * Notify the autograder that the machine is being terminated. <tt>UserProcess.halt()</tt>
   * <i>must</i> call this method.
   */
