...
public final class Processor {
  ...
  private final int[] registers = new int[numUserRegisters];
  ...
  private final int numPhysPages;
  /** Main memory for user programs. */
  private final byte[] mainMemory;
  ...
  private static class Mips {
    ...
    static final char RS = 's',
        ...
        ADDR = 'a', // imm(rs)
        TARGET = 'j',
        RETURNADDRESS = 'r'; // rd, or none if rd=31;
