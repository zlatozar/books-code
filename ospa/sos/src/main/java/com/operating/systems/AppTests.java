    ...
    switch (app_number) {
      ...
      case 2:
        ...
        while (counter < 5) {
          ...
          if (ret == 0) SIM.Trace(SIM.TraceApp, "SENT message " + counter);
          else {
      ...
      case 3:
        ...
        while (true) {
          ...
          if (ret == 0) SIM.Trace(SIM.TraceApp, "RECEIVED message " + SIM.hw.GetCellAsInt(200));
          else {
