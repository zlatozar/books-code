...
class HWSimulation {
  ...
  // ***** Object data *****
  //
  public static HWTimer hwTimer;
  public static Thread hwTimerThread;
  public static HWSimulatedDisk theDisk;
  public static Thread theDiskThread;
  public static int MemoryBaseRegister;
  public static int MemoryLimitRegister;
  ...
  public void SetCellUnmapped(int addr, int n) {
    SetCellUnmapped(addr, new Integer(n));
  }
  ...
  public void SystemCall(int addr) {
    ...
    if (cur_proc != old_cur_proc) ct.suspend();
  ...
  public void WaitForInterrupt() {
    SIM.TheSIM.sosPauser.checkIfPaused();
    SIM.Trace(
        SIM.TraceHWSim, "No process to run.  Suspending " + Thread.currentThread());
  ...
  public void CreateProcess(int app_number, int arg, int pid) {
    ...
    switch (app_number) {
      case 0:
        ...
        SIM.Trace(SIM.TraceHWSim, "create and suspend user 0 " + t);
      ...
      default:
        ...
        SIM.TheSIM.threadList.addElement(t);
        SIM.Trace(SIM.TraceHWSim, "create and suspend user " + app_number + " " + t);
        t.setPriority(Thread.NORM_PRIORITY);
        t.start();
        t.suspend();
        break;
    ...
    // p.add(pscroll);
    /****
     * if( SIM.TheFrame != null )
     * SIM.TheFrame.setVisible(false);
     * else
     * SIM.TheSIM.stop();
     ****/
