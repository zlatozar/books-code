...
class SOSSyscallIntHandler implements SIMIntHandler {
  ...
  public static void MemoryCopy(int from, int to, int len) {
  ...
  public void HandleInterrupt(int addr) {
    ...
    switch (system_call_number) {
      ...
      case CreateProcessSystemCall:
        ...
        SIM.Trace(
            SIM.TraceSOSSyscall,
            "Create system call: pid=" + cur_proc + ", application number=" + app_number);
      ...
      case ExitProcessSystemCall:
        ...
        SIM.Trace(
            SIM.TraceSOSSyscall,
            "Exit system call -- pid=" + cur_proc + ", return code=" + return_code);
      ...
      case CreateMessageQueueSystemCall:
        ...
        SIM.Trace(
            SIM.TraceSOSSyscall,
            "Create message queue system call: pid=" + cur_proc + ", mqid=" + i);
      ...
      case SendMessageSystemCall:
        ...
        MemoryCopy(
            user_msg,
            SIM.MessageBufferArea + SOSProcessManager.MessageSize * msg_no,
      ...
      case ReceiveMessageSystemCall:
        ...
        SIM.Trace(
            SIM.TraceSOSSyscall,
            "Receive message system call, pid="
                + cur_proc
                + ", mqid="
                + from_q
                + ", user msg addr="
        ...
        if (SIM.sosData.message_queue[from_q].isEmpty()) {
          ...
          msg_no = ((Integer) SIM.sosData.message_queue[from_q].firstElement()).intValue();
  ...
  private void FreeMessageBuffer(int msg_no) {
    SIM.hw.SetCellUnmapped(
        SIM.MessageBufferArea + SOSProcessManager.MessageSize * msg_no,
        new Integer(SIM.sosData.free_message_buffer));
